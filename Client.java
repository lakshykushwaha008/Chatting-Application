...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Rengoku.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            JPanel p2 = formatLabel(out, true); // true = sender (client)
    ...
    public static void main(String[] args) {
        ...
        try {
            Socket s = new Socket("127.0.0.1", 6001); // make sure server is running
